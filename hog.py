...
def max_scoring_num_rolls(dice=six_sided):
    ...
    i,count=1,0
    while i<10:
        a=make_averaged(roll_dice)(i)
        if make_averaged(roll_dice)(i+1)>a:
            count=i+1
        else:
            count=i
        i=i+1    
...
def swap_strategy(score,opponent_score,margin=8,num_rolls=5):
    ...
    u=opponent_score%10
    t=opponent_score//10
    if (abs(t-u)+1)+score==opponent_score//2:
        return 0
    else:
        return num_rolls
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    u=opponent_score%10
    t=opponent_score//10
    if swap_strategy(score,opponent_score)==0 and t-u==0:
        return 0
    a=select_dice(score,opponent_score)
    return max_scoring_num_rolls(a)
